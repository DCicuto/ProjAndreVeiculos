    ...
    public class ClientesController : ControllerBase
    {
        ...
        public async Task<ActionResult<IEnumerable<Cliente>>> GetCliente()
        {
          if (_context.Cliente == null)
          {
            ...
            return await _context.Cliente.Include(e => e.Endereco).ToListAsync();//cliente vai incluir cliente dentro de cliente, porque o lambida aqui percorre o endereço e tras o endereço   
        }
        ...
        public async Task<ActionResult<Cliente>> GetCliente(string id)
        {
          if (_context.Cliente == null)
          {
            ...
            var cliente = await _context.Cliente.Include(e => e.Endereco).Where(c => c.Documento == id).FirstOrDefaultAsync();//aqui ele vai trazer o cliente que tem o documento igual ao id que foi passado, dentro do C# criei uma forkey para o endereço, então ele vai trazer o endereço também.
